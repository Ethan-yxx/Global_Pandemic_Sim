...
ggsave("../figs/fig1d.jpeg", page,  width =10, height = 10, units = "cm",dpi=1200,bg="transparent")


ggsave("../figs/fig1d.svg", page,  width =10, height = 10, units = "cm",dpi=1200,bg="transparent")

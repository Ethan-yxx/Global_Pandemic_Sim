...
n1<-apply(odarrayr,c(1,2),FUN="sum")
osum<-apply(n1,1,sum)
...
tpfixb <- set_panel_size(t1,width  = unit(10, "cm"),
                        height = unit(8, "cm"))
ggsave("../figs/fig6b.jpeg", tpfixb,  width =15,
       height = 10, units = "cm",dpi=1200,bg="transparent")
ggsave("../figs/fig6b.svg", tpfixb,  width =15, 
       height = 10, units = "cm",dpi=1200,bg="transparent")
#####################################################################
...
tpfixc <- set_panel_size(t2,width  = unit(10, "cm"),
                         height = unit(8, "cm"))
ggsave("../figs/fig6c.jpeg", tpfixc,  width =15,
       height = 10, units = "cm",dpi=1200,bg="transparent")
ggsave("../figs/fig6c.svg", tpfixc,  width =15, 
       height = 10, units = "cm",dpi=1200,bg="transparent")
